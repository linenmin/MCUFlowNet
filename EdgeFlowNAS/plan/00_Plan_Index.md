...
14. `14_单模型与Supernet训练细节对比及数据利用率优化计划.md`
说明: 对比基准单模型与 supernet 训练细节，量化 run1 数据利用率，并给出分档改进方案。
...
## 新增文档（2026-02-19）
14. `13_Vela_Bilinear基准_Supernet骨架一次性对齐自查计划.md`
说明: 基于无权重 Vela 实测结果的骨架对齐计划与一次性自查清单。
