"""CLI wrapper for Retrain V3 FC2 stage."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Retrain one V3 fixed subnet on FC2")
    parser.add_argument("--config", default="configs/retrain_v3_fc2.yaml")
