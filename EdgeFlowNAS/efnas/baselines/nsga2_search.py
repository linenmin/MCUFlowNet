...
from efnas.nas.search_space_eval import get_num_blocks, get_num_choices, validate_arch_code
...
def load_search_space(module_name: Optional[str] = None) -> SearchSpaceAdapter:
    ...
    return SearchSpaceAdapter(module_name or "efnas.nas.search_space_eval")
...
class NSGA2SearchRunner:
    ...
    def __init__(
        ...
        *,
        ...
        self.search_space = load_search_space(search_cfg.get("search_space_module", "efnas.nas.search_space_eval"))
