...
from efnas.engine.retrain_sintel_runtime import evaluate_checkpoint_dir_on_sintel as _eval_retrain_sintel
...
def evaluate_ablation_checkpoint_dir_on_sintel(
    ...
    import efnas.engine.retrain_evaluator as retrain_eval
