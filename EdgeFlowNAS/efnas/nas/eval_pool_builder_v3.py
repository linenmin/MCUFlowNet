"""Evaluation pool builder for Supernet V3."""
...
from efnas.nas.search_space_v3 import V3_REFERENCE_ARCH_CODE, get_block_specs, get_num_blocks, get_num_choices
...
def _seed_codes() -> List[List[int]]:
    ...
    codes.append([int(item) for item in V3_REFERENCE_ARCH_CODE])
...
def _build_parser() -> argparse.ArgumentParser:
    """Build CLI parser."""
    parser = argparse.ArgumentParser(description="eval pool builder for EdgeFlowNAS V3")
