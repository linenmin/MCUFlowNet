...
EFNAS_ROOT = str(Path(__file__).resolve().parents[2])
if EFNAS_ROOT not in sys.path:
    sys.path.insert(0, EFNAS_ROOT)

from efnas.network.fixed_arch_models import FixedArchModelV3  # noqa: E402
...
def main():
    ...
    ap.add_argument("--sintel-root", default="datasets/MPI-Sintel-complete")
